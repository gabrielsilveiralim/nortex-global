...
export default function Header() {
    ...
    const linkClass = ({ isActive }: { isActive: boolean }) =>
        isActive
          ? 'text-[#1b6eb7] border-b-2 border-[#1b6eb7] pb-1 transition-all duration-300'
          : 'text-[#BBC9CF] hover:text-[#1b6eb7] transition-all duration-300'

    return (
    <>
    <header className='border-b border-[#5F6B7A]/10 bg-[#010910]'> 
